document.addEventListener('DOMContentLoaded', function() {
    ...
    // Appeler la fonction au démarrage pour afficher le message par défaut
    setDefaultMessage();
    ...
    backBtn.addEventListener('click', function() {
        ...
        // Réafficher le message par défaut "bonjour mohamed"
        setDefaultMessage();
        
        // Nettoyer le widget TradingView des kinfopaneltous
        if (currentKinfopaneltousWidget) {
            currentKinfopaneltousWidget.innerHTML = '';
